...
const PlaceOrder = () => {
  ...
  const { navigate, backendUrl, token, cartItems, setCartItems, getCartAmout, delivery_fee, products } = useContext(ShopContext);
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='w-full text-end mt-8'>
            <button type='submit' className='bg-blue-900 text-white px-16 py-3 text-sm'>PLACE ORDER</button>
          </div>
        </div>
      </div>
    </form>
